...
function formHandler(event) {
    ...
    if (username.value && score.value) {
        ...
        username.value = ""; //Gonderdikten sonra sifirladik
        score.value = "";
    } else {
...
/*  
<li class="list-group-item d-flex justify-content-between align-items-center rounded-pill"> Seda <span class="badge bg-primary rounded-pill">12</span>
</li>
*/
